...
def sph_overlaps(bboxes1, bboxes2, mode='iou', is_aligned=False, backend='unbiased_iou'):
    ...
    assert backend in ['unbiased_iou', 'sph2pob_standard_iou', 'sph2pob_legacy_iou', 'sph2pob_efficient_iou', 'naive_iou', 'fov_iou', 'sph_iou', 'kld_iou']
    ...
    elif backend == 'kld_iou':
        iou_calculator = kld_iou
    else:
